...
if(NOT "/home/shams3049/catkin_ws/devel/include;/home/shams3049/catkin_ws/src/simtrack/simtrack_nodes/include " STREQUAL " ")
  set(simtrack_nodes_INCLUDE_DIRS "")
  set(_include_dirs "/home/shams3049/catkin_ws/devel/include;/home/shams3049/catkin_ws/src/simtrack/simtrack_nodes/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simtrack_nodes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shams3049/catkin_ws/src/simtrack/simtrack_nodes/${idir}'.  Ask the maintainer 'Karl Pauwels <karlpauwels@users.noreply.github.com>' to fix it.")
    endif()
